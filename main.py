...
# Video feed
cap = cv2.VideoCapture('Parkingfiles/carPark.mp4')
...
def checkParkingSpace(imgPro):
    ...
    cvzone.putTextRect(img, f'Free: {str(spaceCounter)}/{len(posList)}',(100,50), scale=3, thickness=5, offset=20, colorR=(0,200,0))
